...
public class PannelloCliente1 extends JPanel {
	...
	public PannelloCliente1(){
		...
		// CREAZIONE SEZIONE crudPanelCliente  (racchiude i bottoni per le operazioni CRUD sui clienti) 
			...
			add(crudPanelCliente);
				...
				cardPanel.add(aggiungiClientiPanel, "aggiungiClientiPanel");
				cardPanel.add(modificaClientiPanel, "modificaClientiPanel");
				cardPanel.add(eliminaClientiPanel, "eliminaClientiPanel");
				cardPanel.add(visualizzaClientiPanel, "visualizzaClientiPanel");
				add(cardPanel);

			
					// In the action listeners for the buttons, use the show method of CardLayout to switch to the appropriate panel
					btnAggiungiCliente.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							cardLayout.show(cardPanel, "aggiungiClientiPanel");
						}
					});
					btnModificaCliente.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							cardLayout.show(cardPanel, "modificaClientiPanel");
						}
					});
					btnEliminaCliente.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							cardLayout.show(cardPanel, "eliminaClientiPanel");
						}
					});
					btnVisualizzaCliente.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							cardLayout.show(cardPanel, "visualizzaClientiPanel");
						}
					});
		...
		// CREAZIONE SEZIONE clientePanelSouth (racchiude i pannelli per le operazioni CRUD sui clienti)
			...
			// Bottone modifica cliente	
				...
				JLabel label1 = new JLabel("Label 1 text");
				modificaClientiPanel.add(label1);

				JLabel label2 = new JLabel("Label 2 text");
				modificaClientiPanel.add(label2);
